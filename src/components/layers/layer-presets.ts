...
export const LAYER_GROUPS: LayerGroup[] = [
  {
    ...
    items: [
      ...
      { key: 'shadow', label: '日影包絡', color: '#22d3ee' },
    ],
  },
  {
    label: '日影解析',
    items: [
      ...
      { key: 'shadowMeasurementLines', label: '5m / 10m ライン', color: '#f59e0b' },
      { key: 'shadowHeatmap', label: '時刻別ヒートマップ', color: '#dc2626' },
  ...
  },
  {
    label: '表示',
    items: [
      { key: 'floorPlates', label: '床プレート', color: '#60a5fa' },
    ],
  },
  {
    label: 'パターン比較',
    items: [
      { key: 'buildingPatternLowRise', label: '低層案', color: '#f97316' },
      { key: 'buildingPatternMidHigh', label: '中層案', color: '#a855f7' },
      { key: 'buildingPatternOptimal', label: '最大案', color: '#22d3ee' },
    ],
  },
];
