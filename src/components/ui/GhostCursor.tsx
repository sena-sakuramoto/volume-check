...
export default function GhostCursor({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      if (typeof (composer as { setPixelRatio?: (r: number) => void }).setPixelRatio === 'function') {
        (composer as { setPixelRatio: (r: number) => void }).setPixelRatio(pixelRatio);
      }
    ...
    edgeIntensity, FilmGrainShader, UnpremultiplyPass, maxDevicePixelRatio,
  ]);
